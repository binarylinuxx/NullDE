...
class HyprlandSettingsApp(Adw.Application):
    ...
    def do_activate(self):
        ...
        gaps_in_row.connect("value-changed", self.on_gaps_in_changed)
        ...
        gaps_out_row.connect("value-changed", self.on_gaps_out_changed)
        ...
        border_size_row.connect("value-changed", self.on_border_size_changed)
        ...
        rounding_row.connect("value-changed", self.on_rounding_changed)
        ...
        active_opacity_row.connect("value-changed", self.on_active_opacity_changed)
        ...
        inactive_opacity_row.connect("value-changed", self.on_inactive_opacity_changed)
