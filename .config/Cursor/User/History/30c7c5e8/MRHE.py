...
try:
    import gi.repository.GtkLayerShell as GtkLayerShell
except ImportError:
    print("gtk4-layer-shell Python bindings are required. Try installing 'gtk-layer-shell' or see https://github.com/wmww/gtk-layer-shell for details.")
    sys.exit(1)
